 ...
 */
export function DiffCurriculumFullPageLayout({ pageTitle, introductionSlot, mediaSlot }: DiffCurriculumFullPageLayoutProps) {
  return (
      ...
      <div className="mx-auto max-w-[700px]">
        ...
        <div className="mt-12 flex flex-col items-center gap-6 sm:mt-16">
          {mediaSlot ?? (
            <>
              <div
                className="h-[200px] w-full max-w-[800px] rounded-sm bg-[#1a1a1a] ring-1 ring-[#404040] sm:h-[280px]"
                aria-hidden
              />
